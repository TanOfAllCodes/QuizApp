...
A simple quiz application designed to help educators understand how children learn.
...
### Landing Page
The landing page allows users to select the language (English or German), which can also be changed during the quiz. The visual design is child-friendly, using neutral, light colors to create an engaging experience.

<img width="600" alt="Image 1 - Landing Page Language Selection" src="https://github.com/user-attachments/assets/8d90b4c5-0bb9-48ae-90bf-13cd8ac202ef" />

### Starting the Quiz
The quiz is accessed by clicking the "Start Quiz" button, welcoming users into the interactive experience.

<img width="600" alt="Image 2 - Start Quiz Screen" src="https://github.com/user-attachments/assets/e0a47a1f-fb69-4dc3-9ec5-0cbbaeefce2e" />

### Quiz Interface
The quiz consists of 10 questions, each with four answer options displayed in random order, with only one correct answer. The interface is intuitive, with navigation controls for a seamless experience.

- **First and Last Questions**: The first question hides the "Previous" button, and the last question hides the "Next" button for logical navigation.
